 ...
 * Description: Private operational companion plugin foundation for One Companion.
 * Version: 0.1.0
 * Author: OHI Stack
 * Author URI: https://ohi-stack.example
 * License: Proprietary
...
add_action( 'plugins_loaded', array( one_companion_plugin(), 'run' ) );
